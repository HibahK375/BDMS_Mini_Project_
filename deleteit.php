<?php 
session_start();
require 'file/connection.php'; //add donorsssssssssss. make it on the user page itself. and recievers can search for nearby donors. and change the pincode thing
