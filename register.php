...
<body>
  <?php include 'header.php'; ?>
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="number" name="rcity" placeholder="User pincode" class="form-control mb-3" required>
    ...
    <a href="userlogin.php" class="text-center mb-4" title="Click here">Already have account?</a>
</div>
</div>
</div>
</div>
